...
import 'package:app_rhyme/utils/keyboard_performance_helper.dart';
...
class _SearchMusicAggregatorPageState extends State<SearchMusicAggregatorPage>
  ...
  final KeyboardPerformanceHelper _keyboardHelper = KeyboardPerformanceHelper();
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: OptimizedSearchTextField(
                    style: TextStyle(
                      color: isDarkMode
                          ? CupertinoColors.white
                          : CupertinoColors.black,
            ...
            CupertinoFormSection.insetGrouped(
              ...
              children: [
                CupertinoFormRow(
                  ...
                  child: _keyboardHelper.getOptimizedWidget(
                    context: context,
